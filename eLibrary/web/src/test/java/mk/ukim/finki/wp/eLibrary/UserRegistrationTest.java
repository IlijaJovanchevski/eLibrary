package mk.ukim.finki.wp.eLibrary;

import mk.ukim.finki.wp.eLibrary.model.User;
import mk.ukim.finki.wp.eLibrary.model.enumerations.Role;
import mk.ukim.finki.wp.eLibrary.model.exceptions.InvalidUsernameOrPasswordException;
import mk.ukim.finki.wp.eLibrary.model.exceptions.PasswordsDoNotMatchException;
import mk.ukim.finki.wp.eLibrary.model.exceptions.UsernameAlreadyExistsException;
import mk.ukim.finki.wp.eLibrary.repository.jpa.UserRepository;
import mk.ukim.finki.wp.eLibrary.service.UserService;
import mk.ukim.finki.wp.eLibrary.service.impl.UserServiceImpl;
